...
public class Closedqueue01_graph extends Frame implements ActionListener,WindowListener{
	
	public Closedqueue01_graph(Closedqueue01_sim qsim, int node_index[], int simtime) {
...
//			data.addValue(timequeue[3].get(i), node_index[3]+"", i+"");
			...
			for(int j = 0; j < node_index.length; j++) {
				data.addValue(timequeue[j].get(i), node_index[j]+"", i+"");
			}
		}
